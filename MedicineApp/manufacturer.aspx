<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manufacturer.aspx.cs" Inherits="MedicineApp.manufacturer" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        <asp:HyperLink NavigateUrl="manufacturer.aspx"  runat="server" Text="Manufacturer" CssClass="nav-link"></asp:HyperLink>
                    </li>
                    <li class="nav-item">
        ...
        <div>
            <center><asp:Label Text="Manufacturer Details" ID="manufacturerTitleLbl" runat="server"></asp:Label></center>
        </div>
        <center>
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Donation]"></asp:SqlDataSource>
        </div>
        </center>
    </form>
</body>
